...
function initCharacters() {
    var Iron= new Character("Iron Man ", 80, 10, 5, "./assets/images/iron.jpg");
    var Captin = new Character("Captin America", 200, 50, 30, "./assets/images/CA.jpg");
    var Thor= new Character("Thor", 150, 15, 2, "./assets/images/thor.png");
    var Thanos = new Character("Thanos", 180, 30, 12, "./assets/images/tha.jpeg");
    charArray.push(Iron, Captin, Thor, Thanos);
}
